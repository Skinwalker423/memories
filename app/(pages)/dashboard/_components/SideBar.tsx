...
export const SideBar = () => {
  return (
    <div className='hidden sm:block w-full h-[calc(100vh-8rem)] bg-white dark:bg-slate-900'>
      <aside
        id='sidebar'
        className='fixed left-0 top-50 z-40 h-screen w-64 transition-transform'
        aria-label='Sidebar'
      >
